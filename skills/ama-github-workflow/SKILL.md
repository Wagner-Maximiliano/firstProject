...
**Forgotten label:** Labels encode stream, tier, risk, and complexity for routing and status. If you forget them, the orchestrator cannot schedule or escalate correctly—add them immediately.
